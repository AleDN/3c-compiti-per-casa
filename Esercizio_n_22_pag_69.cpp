...
int main()
{
  ...
  cin>> n;
  cout<<"Inserisci un valore alla volta "<< endl;
  ...
  for(i=0;i<=Q;i++)
  {
    ...
    cout<<" I numeri inseriti che sono minori di X sono:  "<<q_minori<<endl;
    cout<<" I numeri inseriti che sono maggiori di X sono:  "<<q_maggiori<<endl;
    cout<<" I numeri inseriti che sono uguali a X sono:  "<<q_uguali<<endl;
  }
